        ...
        <nav className="space-y-2">
          ...
          >
            <div className="mr-3">
              ...
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path
                  d="M10 2a8 8 0 100 16 8 8 0 000-16zm-1 3a1 1 0 011-1h1a1 1 0 110 2h-1a1 1 0 01-1-1zm-2 5a1 1 0 011-1h3a1 1 0 110 2h-3a1 1 0 01-1-1zm-2 4a1 1 0 011-1h5a1 1 0 110 2h-5a1 1 0 01-1-1z"
                  clipRule="evenodd"
                  fillRule="evenodd"
                ></path>
              </svg>
          ...
          >
            <div className="mr-3">
              {/* Icon Modul */}
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm0 2h12v10H4V5zm2 2h8a1 1 0 010 2H6a1 1 0 010-2zm0 4h5a1 1 0 010 2H6a1 1 0 010-2z"></path>
              </svg>
            </div>
            Modul
          </Link>
          ...
          >
            <div className="mr-3">
              ...
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path
                  d="M10 9a3 3 0 100-6 3 3 0 000 6zM2 17a8 8 0 1116 0H2z"
                  clipRule="evenodd"
                  fillRule="evenodd"
                ></path>
              </svg>
